...
const translations = {
  pt: {
    ...
    contact: "Contato",
    contact_btn: "Contato",
    logo: "Aguiar & Oliveira",

    // Hero Section
    hero_title_1: "Aguiar &",
    hero_title_2: "Oliveira",
    ...
    marquee_text: "AGUIAR & OLIVEIRA ADVOGADOS ASSOCIADOS • ADVOCACIA PREVIDENCIÁRIA • APOSENTADORIA • SEGURANÇA SOCIAL • PENSÕES • BENEFÍCIOS • BOA VISTA • RORAIMA • BRASIL • ",

    // About Section
    about_title: "Escritório Aguiar & Oliveira Advogados Associados",
    about_intro: "Advogados especializados em Direito Previdenciário em Boa Vista, Roraima. Atuação dedicada e personalizada para garantir seus direitos junto ao INSS.",
    about_established: "Fundado em 2018",
    about_desc_1: "O Escritório Aguiar & Oliveira Advogados Associados destaca-se pela excelência no atendimento personalizado e artesanal no âmbito do Direito Previdenciário (Segurança Social). Compreendemos que cada caso representa a história de vida e o futuro de um trabalhador, por isso empenhamos máxima precisão técnica e atenção aos detalhes em cada requerimento de benefício.",
    about_desc_2: "Nossa sede fica localizada na Av. Brg. Eduardo Gomes, 1733 - Aparecida, Boa Vista - RR, oferecendo um atendimento humanizado e acolhedor para a comunidade local e regional, com elevado índice de resolutividade e dedicação.",
    ...
    contact_hours_mon_wed: "Segunda a Quarta: 09h às 19h",
    contact_hours_thu: "Quinta-feira: 09h às 19h",
    contact_hours_fri: "Sexta-feira: 09h às 19h",
    contact_hours_sat_sun: "Sábado e Domingo: Fechado",
    contact_address_val: "Av. Brg. Eduardo Gomes, 1733 - Aparecida, Boa Vista - RR, 69305-005, Brasil",

    // Google Reviews Card
    reviews_title: "Avaliações no Google",
    reviews_subtitle: "O que dizem os nossos clientes no Google Maps",
    reviews_rating_summary: "Classificação de 5,0 de 51 avaliações no Google Maps",
    review_julian_name: "Patricia Kelly Lima",
    review_julian_text: "Excelente atendimento e profissionalismo! Tive uma experiência incrível com o escritório Aguiar & Oliveira. A advogada,...",
    review_julian_reply: "Muito obrigado pelos seus comentários tão positivos! Nos alegra enormemente saber que nosso trabalho cumpriu e inclusive superou suas expectativas.",
    review_miguel_name: "Alberto Coelho",
    review_miguel_text: "Recebi um atendimento profissional, eficiente e atencioso. O escritório demonstrou profundo conhecimento jurídico e um grande compromisso com meu caso...",
    review_miguel_reply: "Muito obrigado pelos seus comentários tão positivos! Nos alegra enormemente saber que nosso trabalho cumpriu e inclusive superou suas expectativas.",
    review_fran_name: "Thais Ferreira",
    review_fran_text: "Profissionais que atuam com rapidez, dedicação e que transmitem confiança. No decorrer do processo, toda assistência necessária e a satisfação de no final ter seu direito garantido.",
    review_reply_label: "Resposta de Aguiar & Oliveira",
  ...
  es: {
    ...
    hero_cta: "Agendar Consulta",
    marquee_text: "AGUIAR & OLIVEIRA ADVOGADOS ASSOCIADOS • ABOGACÍA DE LA SEGURIDAD SOCIAL • JUBILACIONES • PENSIONES • BENEFICIOS • BOA VISTA • RORAIMA • BRASIL • ",

    // About Section
    about_title: "Estudio Jurídico Aguiar & Oliveira Advogados Associados",
    about_intro: "Abogados especializados en Derecho de la Seguridad Social en Boa Vista, Roraima. Actuación dedicada y personalizada para garantizar sus derechos ante el INSS.",
    about_established: "Fundado en 2018",
    about_desc_1: "El Estudio Jurídico Aguiar & Oliveira Advogados Associados se destaca por la excelencia en la atención personalizada y artesanal en el ámbito del Derecho de la Seguridad Social. Comprendemos que cada caso representa la historia de vida y el futuro de un trabajador, por lo que empleamos la máxima precisión técnica y atención al detalle en cada solicitud de beneficio.",
    about_desc_2: "Nuestra sede principal se encuentra ubicada en Av. Brg. Eduardo Gomes, 1733 - Aparecida, Boa Vista - RR, ofreciendo una atención humana y acogedora a la comunidad local y regional, con un alto índice de resolución y dedicación.",
    ...
    contact_hours_mon_wed: "Lunes a Miércoles: 09h a 19h",
    contact_hours_thu: "Jueves: 09h a 19h",
    contact_hours_fri: "Viernes: 09h a 19h",
    ...
    reviews_rating_summary: "Calificación de 5,0 de 51 opiniones en Google Maps",
    review_julian_name: "Patricia Kelly Lima",
    review_julian_text: "¡Excelente servicio y profesionalismo! Tuve una experiencia increíble con el despacho de Aguiar & Oliveira. La abogada,...",
    review_julian_reply: "¡Muchísimas gracias por sus comentarios tan positivos! Nos alegra enormemente saber que nuestro trabajo cumplió e incluso superó sus expectativas.",
    review_miguel_name: "Alberto Coelho",
    review_miguel_text: "Recibí un servicio profesional, eficiente y atento. El bufete demostró un profundo conocimiento jurídico y un gran compromiso con mi caso...",
    review_miguel_reply: "¡Muchísimas gracias por sus comentarios tan positivos! Nos alegra enormemente saber que nuestro trabajo cumplió e incluso superó sus expectativas.",
    review_fran_name: "Thais Ferreira",
    review_fran_text: "Profesionales que actúan con rapidez, dedicación y que transmiten confianza. Durante el proceso, toda la asistencia necesaria y la satisfacción de, al final, tener su derecho garantizado.",
    review_reply_label: "Respuesta de Aguiar & Oliveira",
