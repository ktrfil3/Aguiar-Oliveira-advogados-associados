      ...
      <div className="container">
        ...
        <section className="about-portrait">
          <div className="about-row">
            <div className="about-col">
              ...
              <br />
              <p>
                <span>{t("about_email")}: </span> <span>contato@rivaniasaraiva.adv.br</span>
              </p>
              <p>
                <span>{t("about_phone")}: </span> <span>+55 95 99138-1406</span>
              </p>
              <p>
        ...
        <section className="about-contact">
          <div className="about-contact-copy">
            ...
            <br />
            <p>
              <span>+55 95 99138-1406</span>
            </p>
            <p>
              <span>contato@rivaniasaraiva.adv.br</span>
            </p>
          </div>
        </section>
